...
paused=!paused;
//camerae.GetComponent(SepiaToneEffect).enabled=true;
}
}*/
var skin:GUISkin;
...
camMouse = gameObject.Find("player").GetComponent("MouseLook");
...
private var toolbarStrings: String[]= ["Audio","Graphics","Stats"];
